...
export class BackendStack extends cdk.NestedStack {
  ...
  private createCopilotKitRuntimeApi(config: AppConfig, frontendUrl: string): void {
    ...
    const langgraphRuntimeArn =
      config.stack_name_base === "langgraph-stack"
        ? this.runtimeArn
        : ssm.StringParameter.valueForStringParameter(this, "/langgraph-stack/runtime-arn")
    const strandsRuntimeArn =
      config.stack_name_base === "strands-stack"
        ? this.runtimeArn
        : ssm.StringParameter.valueForStringParameter(this, "/strands-stack/runtime-arn")
