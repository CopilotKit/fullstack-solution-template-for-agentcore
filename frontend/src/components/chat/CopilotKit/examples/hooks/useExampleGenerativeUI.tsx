...
import { PieChart, PieChartPropsSchema } from "@/components/chat/CopilotKit/examples/generative-ui/PieChart"
import { BarChart, BarChartPropsSchema } from "@/components/chat/CopilotKit/examples/generative-ui/BarChart"
import { ToolReasoning } from "@/components/chat/CopilotKit/examples/generative-ui/ToolReasoning"
import { MeetingTimePicker } from "@/components/chat/CopilotKit/examples/generative-ui/MeetingTimePicker"
import { useTheme } from "@/components/chat/CopilotKit/examples/hooks/useExampleTheme"

export const useExampleGenerativeUI = () => {
